...
#var MAIN_LEVEL = load("res://levels/main_level/main_level.tscn")
var MAIN_LEVEL = load("res://levels/level_main.tscn")
...
var FORCE_SLEEP_TRANSITION = load("res://common/ui/scene_transitions/force_sleep_transition.tscn")
var CREDITS = load("res://common/ui/screens/credits.tscn")
#var SCENARIOS_MENU = load("res://common/ui/screens/scenario_menu/scenario_menu.tscn")
